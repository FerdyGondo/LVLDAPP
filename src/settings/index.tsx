...
const data = [{name: "Two Step Verification", screen: "Verification"},{name: "Personal Info", screen: ""},{name: "Update Password", screen: "UpdatePassword"},{name: "Update Email", screen: ""}]

        ...
        <Container>
            <TopContainer>
                ...
                <TouchableOpacity  onPress={ () => { navigation.navigate("Rules")}} >
                    <DrawerItemStyle><DrawerTextStyle>Rules and Gameplay</DrawerTextStyle><Icon  name="chevron-right"  size={20} /></DrawerItemStyle>
                </TouchableOpacity>
                <TouchableOpacity  onPress={ () => { navigation.navigate("Faq")}} >
                    <DrawerItemStyle><DrawerTextStyle>FAQ</DrawerTextStyle><Icon  name="chevron-right"  size={20} /></DrawerItemStyle>
                </TouchableOpacity>            
                <TouchableOpacity  onPress={ () => { navigation.navigate("Privacy")}} >
                    <DrawerItemStyle><DrawerTextStyle>Terms of Use</DrawerTextStyle><Icon  name="chevron-right"  size={20} /></DrawerItemStyle>
                </TouchableOpacity>        
